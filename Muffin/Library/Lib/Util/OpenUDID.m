...
//  KDB_Smart
//
//  Created by Kim SungJin on 13. 6. 30..
//
//
...
//#error This file uses the classic non-ARC string/release model; hints below...
...
+ (NSString*) valueWithError:(NSError **)error {
    ...
    for (int n=0; n<kOpenUDIDRedundancySlots; n++) {
        ...
        if (slotPB==nil) {
            // weak availableSlotPBid to be the first one available
